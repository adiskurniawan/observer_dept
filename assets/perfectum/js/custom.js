...
function calendars(){
	...
	$('#main_calendar').fullCalendar({
		...
		events: [
			{
				title: '5000 Light Roast',
				start: new Date(y, m, 1)
			},
			{
				title: '2000 Dark Roast',
				start: new Date(y, m, 15)
			},
			{
				title: '500 Brazillian Blend',
				start: new Date(y, m, 3)
			},
			{
				title: '100 Breakfast Blend',
				start: new Date(y, m, 15)
			},
			{
				title: '320 Pike Place Roast',
			...
			{
				title: 'Startup Weekend (9000+ Columbian Blend Coffee)',
...
function charts() {
	...
	if($("#stats-chart").length)
	{
		...
		var plot = $.plot($("#stats-chart"),
			   [ { data: pageviews, label: "pageviews"}, { data: visitors, label: "subscribers" } ], {
				   series: {
					   lines: { show: true,
								lineWidth: 3,
...
function growlLikeNotifications() {
	...
	$('#add-sticky').click(function(){
		...
		var unique_id = $.gritter.add({
			...
			image: 'assets/perfectum/img/avatar.jpg',
