...
function get_people_manage_table($people,$controller)
{
	...
	$CI->lang('common_last_name'),
	$CI->lang('common_first_name'),
	$CI->lang('common_email'),
	$CI->lang('common_phone_number'),
	'&nbsp');
...
function get_people_manage_table_data_rows($people,$controller)
{
	...
	{
		$table_data_rows.="<tr><td colspan='6'><div class='warning_message' style='padding:7px;'>".$CI->lang('common_no_persons_to_display')."</div></tr></tr>";
	}
...
function get_person_data_row($person,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/view/$person->person_id/width:$width", $CI->lang('common_edit'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_update'))).'</td>';		
	$table_data_row.='</tr>';
...
function get_supplier_manage_table($suppliers,$controller)
{
	...
	$headers = array('<input type="checkbox" id="select_all" />',
	$CI->lang('suppliers_company_name'),
	$CI->lang('common_last_name'),
	$CI->lang('common_first_name'),
	$CI->lang('common_email'),
	$CI->lang('common_phone_number'),
...
function get_supplier_manage_table_data_rows($suppliers,$controller)
{
	...
	{
		$table_data_rows.="<tr><td colspan='7'><div class='warning_message' style='padding:7px;'>".$CI->lang('common_no_persons_to_display')."</div></tr></tr>";
	}
...
function get_supplier_data_row($supplier,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/view/$supplier->person_id/width:$width", $CI->lang('common_edit'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_update'))).'</td>';		
	$table_data_row.='</tr>';
...
*/
function get_items_manage_table($items, $controller='items') {
	$CI =& get_instance();
	$table='<table class="tablesorter" id="sortable_table">';
	
	$headers = array('<input type="checkbox" id="select_all" />', 
	$CI->lang('items_item_number'),
	$CI->lang('items_name'),
	$CI->lang('items_category'),
	$CI->lang('items_cost_price'),
	$CI->lang('items_unit_price'),
	$CI->lang('items_tax_percents'),
	$CI->lang('items_quantity'),
	'&nbsp;',
	$CI->lang('items_inventory')
	);
...
function get_items_manage_table_data_rows($items,$controller) {
	...
	if($items->num_rows()==0) {
		$table_data_rows.="<tr><td colspan='11'><div class='warning_message' style='padding:7px;'>".$CI->lang('items_no_items_to_display')."</div></tr></tr>";
	}
...
function get_item_data_row($item,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/view/$item->item_id/width:$width", $CI->lang('common_edit'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_update'))).'</td>';		
	
	//Ramel Inventory Tracking
	$table_data_row.='<td width="10%">'.anchor($controller_name."/inventory/$item->item_id/width:$width", $CI->lang('common_inv'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_count')))./*'</td>';//inventory count	
	$table_data_row.='<td width="5%">'*/'&nbsp;&nbsp;&nbsp;&nbsp;'.anchor($controller_name."/count_details/$item->item_id/width:$width", $CI->lang('common_det'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_details_count'))).'</td>';//inventory details	
...
function get_giftcards_manage_table( $giftcards, $controller )
{
	...
	$headers = array('<input type="checkbox" id="select_all" />', 
	$CI->lang('giftcards_giftcard_number'),
	$CI->lang('giftcards_card_value'),
	'&nbsp', 
	);
...
function get_giftcards_manage_table_data_rows( $giftcards, $controller )
{
	...
	{
		$table_data_rows.="<tr><td colspan='11'><div class='warning_message' style='padding:7px;'>".$CI->lang('giftcards_no_giftcards_to_display')."</div></tr></tr>";
	}
...
function get_giftcard_data_row($giftcard,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/view/$giftcard->giftcard_id/width:$width", $CI->lang('common_edit'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_update'))).'</td>';		
...
function get_item_kits_manage_table( $item_kits, $controller )
{
	...
	$headers = array('<input type="checkbox" id="select_all" />', 
	$CI->lang('item_kits_name'),
	$CI->lang('item_kits_description'),
	'&nbsp', 
	);
...
function get_item_kits_manage_table_data_rows( $item_kits, $controller )
{
	...
	{
		$table_data_rows.="<tr><td colspan='11'><div class='warning_message' style='padding:7px;'>".$CI->lang('item_kits_no_item_kits_to_display')."</div></tr></tr>";
	}
...
function get_item_kit_data_row($item_kit,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/view/$item_kit->item_kit_id/width:$width", $CI->lang('common_edit'),array('class'=>'thickbox','title'=>$CI->lang($controller_name.'_update'))).'</td>';		
