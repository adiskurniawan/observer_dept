...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<head>
		...
		<script src="<?php echo base_url(); ?>assets/default/js/libs/jquery-1.9.1.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            $(function()
            {
                ...
                $('.invoice-add-payment').click(function() {
                    invoice_id = $(this).data('invoice-id');
                    $('#modal-placeholder').load("<?php echo site_url('payments/ajax/modal_add_payment'); ?>", {invoice_id: invoice_id});
                });
