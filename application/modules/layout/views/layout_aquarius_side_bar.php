    <div class="menu">                
        ...
        <!-- <div class="admin">
            <div class="image">
                <img src="<?php // echo base_url(); ?>assets/aquarius/img/users/aqvatarius.jpg" class="img-polaroid"/>                
            </div>
            <ul class="control">                
        ...
        <ul class="navigation">            
            <li class="active">
                <a href="<?php echo base_url(); ?>demo_aquarius/dashboard">
            ...
            <li class="openable">
                ...
                <ul>
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/ui">
                            <span class="icon-th"></span><span class="text">UI Elements</span>
                        </a>                  
                    </li>          
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/widgets">
                            <span class="icon-th-large"></span><span class="text">Widgets</span>
                        </a>                  
                    </li>                     
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/buttons">
                            <span class="icon-chevron-right"></span><span class="text">Buttons</span>
                        </a>                  
                    </li> 
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/icons">
            ...
            <li>
                <a href="<?php echo base_url(); ?>demo_aquarius/forms">
            ...
            <li class="openable">
                ...
                <ul>
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/messages">
            ...
            <li>
                <a href="<?php echo base_url(); ?>demo_aquarius/statistic">
                    <span class="isw-graph"></span><span class="text">Statistics</span>
                </a>
            </li>                                    
            <li>
                <a href="<?php echo base_url(); ?>demo_aquarius/tables">
            ...
            <li class="openable">
                ...
                <ul>
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/gallery">
                            <span class="icon-picture"></span><span class="text">Gallery</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/typography">
                            <span class="icon-pencil"></span><span class="text">Typography</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>demo_aquarius/users">
